...
<head>
    ...
    <title>Customers of our Bank</title>
...
<body style="background-color:#212529;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(3, 3, 31); padding:5px 5px 5px 5px; border-radius:20px; box-shadow: 2px 2px 10px gray;">
