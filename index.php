...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/Logo2 32x32 (1).png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/Logo2 (1).png">
...
<body style="background-color:#0b0f12;">
...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px purple; text-align:center;"><b>Welcome to <br> Sky
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/vector.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Check our features</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <h5>All of our Customers are Listing .</h5>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Here, Send Money to people Listed in our Bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
