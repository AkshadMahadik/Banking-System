...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="statics/Logo2.png">
    ...
    <title>Send money - Sky Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:#282829; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div    
                style="width:80%; background-color:rgba(3, 3, 31); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
